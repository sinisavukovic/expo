...
- Add `showInRecents` option to the `AuthSessions.startAsync` which determining whether browsed website should be shown as separate entry in Android recents/multitasking view. ([#6701](https://github.com/expo/expo/pull/6701) by [@esamelson](https://github.com/esamelson))
...
- Fixed `Facebook SDK` not being filly initialized error. ([#6527](https://github.com/expo/expo/pull/6527) by [@sjchmiela](https://github.com/sjchmiela))
- Fixed `Battery` import breaking on Web. ([#6545](https://github.com/expo/expo/pull/6545) by [@evanbacon](https://github.com/EvanBacon))
- Fixed `RedBox` covering by notch on Android. ([#6644](https://github.com/expo/expo/pull/6644) by [@cruzach](https://github.com/cruzach))
- Fixed SSR supprot in `ErrorRecovery`. ([#6672](https://github.com/expo/expo/pull/6672) by [@evanbacon](https://github.com/EvanBacon))
...
- Fixed `StoreReview.requestReview` thrownig `NullPointerException` in the bare workflow. ([#6713](https://github.com/expo/expo/pull/6713) by [@cruzach](https://github.com/cruzach))
...
- Fixed `LocalAuth.authenticateAsync` resulting in the `user_cancel` error immediately on Android. ([#6846](https://github.com/expo/expo/pull/6846) by [@LinusU](https://github.com/LinusU))
...
- Fixed `HeadlessAppLoader` crashing after the activity was killed. ([#6879](https://github.com/expo/expo/pull/6879) by [@tasn](https://github.com/tasn))
